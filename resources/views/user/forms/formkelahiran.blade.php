<div class="card">
    ...
    <div class="card-body">
        <form id="form-mail" method="post" enctype="multipart/form-data">
            ...
            <div class="form-group">
                <input type="text" name="namaistri" placeholder="Tulis Nama Istri" class="form-control" required>
            </div>
            <div class="form-group">
                <input type="text" name="namaanak" placeholder="Tulis Nama Anak Yang Lahir" class="form-control" required>
            </div>
            <div class="form-group">
                <input type="date" name="tgllahir" placeholder="Tulis Nama Anak Yang Lahir" class="form-control" required>
            </div>
            <div class="form-group">
                <input type="text" name="kotalahir" placeholder="Tulis Nama Kota" class="form-control" required>
            </div>
            <div class="form-group">
            ...
            <div class="form-group">
                <input type="text" name="anakke" placeholder="Anak Ke (Tulis dengan Abjad)" class="form-control" required>
            </div>
