<div class="card">
    ...
    <div class="card-body">
        <form id="form-mail" method="post" enctype="multipart/form-data">
            ...
            <div class="form-group">
                <input type="text" name="sebabkematian" placeholder="Tulis Sebab Kematian" class="form-control" required>
            </div>
            <div class="form-group">
                <input type="date" name="tglkematian" class="form-control" required>
            </div>
            <div class="form-group">
                <input type="text" name="tempatkematian" placeholder="Tulis Tempat Kematian" class="form-control" required>
            </div>
