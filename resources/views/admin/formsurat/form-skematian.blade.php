...
<form action="{{ route('admin.surat.number') }}" method="post">
    ...
    <div class="form-group">
        <input type="text" name="sebabkematian" value="{{ $maildata['sebabkematian'] }}" placeholder="Tulis Sebab Kematian" class="form-control" required>
    </div>
    <div class="form-group">
        <input type="date" name="tglkematian" value="{{ $maildata['tglkematian'] }}" class="form-control" required>
    </div>
    <div class="form-group">
        <input type="text" name="tempatkematian" value="{{ $maildata['tempatkematian'] }}" placeholder="Tulis Tempat Kematian" class="form-control" required>
    </div>
